...
avg_wagerate_growth <- .038 # used .038 2023 to 2025
avg_emp_growth <- .018      # used .03 2023 to 2025
...
empgrowth <- avg_emp_growth
avgwagegrowth <- avg_wagerate_growth

pmtfc <- pmtdb |> 
  mutate(year=2024,
         gemp = gemp * (1 + empgrowth) * empcalib,
         gpayroll = gpayroll * (1 + avgwagegrowth) * (1 + empgrowth) * empcalib * wagecalib) |> 
  # get per- variables
