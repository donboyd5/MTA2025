...
cshares1 <- readRDS(fs::path(PDINTERMEDIATE, "cbp_estab_shares.rds"))
cshares <- cshares1 |> 
  mutate(area=paste0(area, " County"))
...
fixstubs <- fix1 |> 
  select(area, nyc, ownerf, owner, naics, naics_level, title, year, estab, avgemp, totwage)
...
qcshares <- qcshares1 |> 
  ...
  select(area, nyc, ownerf, owner, naics, naics_level, title, cnaics, year, estab, avgemp, totwage, n0_4:n1000_inf)
