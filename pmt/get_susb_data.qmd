...
## Fill out the missing firm size information using NY state data
...
nys2 |> filter(is.na(firms))
  
count(nys2, fscode, firmsize)
count(nys2, naics, description)  
...
## Use NYS shares to fill in missing firm size data for MTA
