...
qcew1 <- readRDS(fs::path(PMTDINTERMEDIATE, "qcewstco"))

count(qcew1 |> filter(areatype=="state"), area)
count(qcew1 |> filter(areatype=="county"), area)
# 65: 57 + 5 NYC +
...
qcew |> filter(areatype=="state", year==2022, ownerf==0)
