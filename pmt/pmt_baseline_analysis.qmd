...
write.xlsx(data1, file=fs::path(PDMTA, "baseline_2024tax_by_county_and_establishment_payroll.xlsx"))

```

<a href="data/for_mta/baseline_2024tax_by_county_and_establishment_payroll.xlsx" download>Download the Excel file</a>

[Download Excel File](data/for_mta/baseline_2024tax_by_county_and_establishment_payroll.xlsx)
